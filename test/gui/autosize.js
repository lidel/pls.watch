module.exports = {
  ...
  'Autosize of Imgur image' : function (browser) {
    browser
      ...
      .assert.cssClassPresent('#autosize-toggle','ticker')
      .getElementSize('#player', function(result) {
        console.log('For 640x360 window Imgur player fits inside of 320x240');
      ...
      .pause(800) //wait for animation to finish
      .getElementSize('#player', function(result) {
        console.log('For 1920x1080 window Imgur player fits inside of 1280x720');
      ...
      .pause(800) //wait for animation to finish
      .getElementSize('#player', function(result) {
        console.log('When autosize is disabled, default Imgur player fits inside of 640x360');
        this.assert.cssClassNotPresent('#autosize-toggle','ticker');
